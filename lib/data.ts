...
export const drinkData: Record<number, DrinkData> = {
  ...
  2: {
    ...
    funny: {
      zh: '內斂之人配以療癒心情，此杯恰到好處。品嚐之後，你將是船上最具氣質的旅客。',
  ...
  3: {
    ...
    funny: {
      zh: '好奇心旺盛又渴望溫暖療癒，此乃船長為你特製之選。品飲之後，你將化身海上哲學家。',
